...
(function () {
  ...
  function homeHtml() {
    ...
    return '<div class="hero">'
      ...
      + row('pools', 'Pools', 'Liquidity pools and positions.')
  ...
  function securityHtml() {
    ...
    var secExp = EXPLORER[SEC_CHAIN] || 'https://etherscan.io';
    return '<div class="ww-head"><h1 class="page-title">Security Module</h1>'
      + '<button class="buy-btn" type="button">Staking</button></div>'
      + '<div class="addr"><a href="' + secExp + '/token/' + SEC_TOKEN + '" target="_blank" rel="noopener">' + SEC_TOKEN + ' \u2197</a></div>'
  ...
  function poolsHtml() {
    return '<div class="ww-head"><h1 class="page-title">Pools</h1>'
      + '<button class="buy-btn" type="button">Add Liquidity</button></div>'
      + '<div class="tbl-wrap"><div class="note">Pools coming soon.</div></div>';
  }
  ...
  function treasuryHtml(data) {
    ...
    return '<div class="ww-head"><h1 class="page-title">Treasury</h1>'
      + '<button class="buy-btn" type="button">Redeem</button></div>'
      ...
      + '<div class="ww-panel">'
      + '<div class="mcap"><span class="mcap-k">Total Value</span><span class="mcap-v">' + fmtUsd(data ? data.fiatTotal : 0) + '</span></div>'
      + '<table class="tbl tbl-flush"><thead><tr><th>Asset</th><th class="num">Balance</th><th class="num">Value</th></tr></thead><tbody>' + rows + '</tbody></table>'
      + '</div>';
  }
  ...
  function renderPage(key) {
    ...
    if (key === 'pools') { c.innerHTML = poolsHtml(); return; }
