...
(function () {
  ...
  function wwHtml() {
    ...
    return '<h1 class="page-title">' + esc(name) + ' <span style="font-variant:normal;color:var(--dim);font-size:20px">(' + esc(baseSym) + ')</span>'
      ...
      + '<div class="buy-row"><button class="buy-btn" data-buy type="button">Buy $BNKR</button></div>'
  ...
  document.addEventListener('click', function (e) {
    ...
    if (b) { if (window.weiwordWallet && window.weiwordWallet.buy) window.weiwordWallet.buy(); return; }
